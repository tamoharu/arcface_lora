...
from insightface.utils_distributed_sampler import DistributedSampler
from insightface.utils_distributed_sampler import get_dist_info, worker_init_fn
...
class DALIWarper(object):
    ...
    def __next__(self):
        ...
        if torch.cuda.is_available():
            ...
            tensor_label: torch.Tensor = data_dict['label'].long()
